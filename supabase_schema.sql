...
CREATE TABLE IF NOT EXISTS profiles (
    ...
    display_name TEXT,
    phone TEXT,
    role TEXT NOT NULL DEFAULT 'USUARIO' CHECK (UPPER(BTRIM(role)) IN ('SUPERADMIN', 'GLOBAL_ADMIN', 'ADMIN_CLIENTE', 'ADMINISTRADOR', 'DIRECTOR', 'COORDINADOR', 'USUARIO', 'USUARIO_LIMITADO')),
